...
describe('Sulfuras', function () {
  ...
  it('Always quality 80', function () {
    const sulfurasShop = new Shop([new Item(SULFURAS, 0, 80)])
    const items = sulfurasShop.updateQuality()
...
describe('BackstagePasses', function () {
  ...
  it('0 after expiry', function () {
    const backstage = new Shop([new Item(PASSES, 0, 10)])
  ...
  it('+2 less than 10 days from sellIn', function () {
    const backstage = new Shop([new Item(PASSES, 8, 10)])
    const items = backstage.updateQuality()
  ...
  it('+3 less than 5 days from sellIn', function () {
    const backstage = new Shop([new Item(PASSES, 3, 10)])
    const items = backstage.updateQuality()
...
describe('AgedBrie', function () {
  ...
  it('Quality under 50', function () {
    const agedBrie = new Shop([new Item(BRIE, 1, 50)])
  ...
  it('Increase after expiry', function () {
    const agedBrie = new Shop([new Item(BRIE, -1, 10)])
    const items = agedBrie.updateQuality()
    expect(items[0].quality).toBe(12)
  })
})
...
describe('Normal', function () {
  ...
  it('x2 after sellIn', function () {
    ...
    const items = normal.updateQuality()
...
describe('Conjured', function () {
  ...
  it('-2 before sellIn', function () {
    const conjured = new Shop([new Item(CONJURED, 10, 10)])
  ...
  it('-4 after sellIn', function () {
    const conjured = new Shop([new Item(CONJURED, -1, 10)])
    const items = conjured.updateQuality()
